...
<body>
  <div class="content">
    <div class="box">
      ...
      <form action="">
        <p>First Name</p>
        <input id="fname" name="fname" class="search-bar" type="text" placeholder="Enter First Name" required>
         <p>Last Name</p>
        <input id="Lname" name="Lname" class="search-bar" type="text" placeholder="Enter First Name" required>
        <p>Usename</p>
